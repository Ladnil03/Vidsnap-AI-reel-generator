...
void main() {
  ...
  group('AuthInterceptor onRequest', () {
    test('attaches Bearer token to private requests when token exists', () async {
      ...
      expect(handler.nextOptions?.headers['Authorization'], equals('Bearer my_test_jwt_token'));
    });
