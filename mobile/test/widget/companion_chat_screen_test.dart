  ...
  group('CompanionChatScreen Widget Tests', () {
    ...
    Widget createWidget() {
      return ProviderScope(
        overrides: [
          companionRepositoryProvider.overrideWithValue(fakeRepo),
        ],
    ...
    testWidgets('renders companion screen, mood chips, initial message and input bar', (tester) async {
      ...
      expect(find.text('Welcome! How are you feeling today?'), findsOneWidget);
    ...
    testWidgets('typing message and tapping send button sends message and displays reply', (tester) async {
      await tester.pumpWidget(createWidget());
      await tester.pumpAndSettle();
      ...
      expect(find.text('I found great recommendations for "Tell me something cool"!'), findsOneWidget);
      expect(find.text('AI Filmmaking 101'), findsOneWidget);
    });

    testWidgets('tapping suggested action chip sends query directly', (tester) async {
      await tester.pumpWidget(createWidget());
      await tester.pumpAndSettle();
      ...
      expect(find.text('I found great recommendations for "Show trending reels"!'), findsOneWidget);
    });
  });
}
